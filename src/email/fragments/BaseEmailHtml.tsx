    ...
    <Html>
      ...
      <body style={{ wordSpacing: "normal", backgroundColor: "#F3F4F6" }}>
        <div style={{ backgroundColor: "#F3F4F6" }}>
          <RawHtml
            html={`<!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;;mso-line-height-rule:exactly;"><![endif]-->`}
          />
          ...
          >
            <RawHtml
              html={`<!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" className="" style="width:600px;" width="600" bgcolor="#FFFFFF" ><tr><td style="line-height:0px;;mso-line-height-rule:exactly;"><![endif]-->`}
            />
            <div
              style={{
                background: "#FFFFFF",
